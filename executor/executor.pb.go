...
type Event struct {
	...
	Type         Event_Type          `protobuf:"varint,1,opt,name=type,enum=mesos.v1.executor.Event_Type" json:"type"`
...
type Event_Subscribed struct {
	...
	FrameworkInfo mesos_v1.FrameworkInfo `protobuf:"bytes,2,req,name=framework_info" json:"framework_info"`
	AgentInfo     mesos_v1.AgentInfo     `protobuf:"bytes,3,req,name=agent_info" json:"agent_info"`
...
type Event_Launch struct {
	Task mesos_v1.TaskInfo `protobuf:"bytes,1,req,name=task" json:"task"`
}
...
type Event_LaunchGroup struct {
	TaskGroup mesos_v1.TaskGroupInfo `protobuf:"bytes,1,req,name=task_group" json:"task_group"`
}
...
type Call struct {
	...
	Type      Call_Type       `protobuf:"varint,3,opt,name=type,enum=mesos.v1.executor.Call_Type" json:"type"`
...
type Call_Subscribe struct {
	UnacknowledgedTasks   []mesos_v1.TaskInfo `protobuf:"bytes,1,rep,name=unacknowledged_tasks" json:"unacknowledged_tasks"`
...
func (this *Event_Launch) String() string {
	...
	s := strings.Join([]string{`&Event_Launch{`,
		`Task:` + strings.Replace(strings.Replace(this.Task.String(), "TaskInfo", "mesos_v1.TaskInfo", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *Event_LaunchGroup) String() string {
	...
	s := strings.Join([]string{`&Event_LaunchGroup{`,
		`TaskGroup:` + strings.Replace(strings.Replace(this.TaskGroup.String(), "TaskGroupInfo", "mesos_v1.TaskGroupInfo", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Call_Subscribe) String() string {
	...
	s := strings.Join([]string{`&Call_Subscribe{`,
		`UnacknowledgedTasks:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.UnacknowledgedTasks), "TaskInfo", "mesos_v1.TaskInfo", 1), `&`, ``, 1) + `,`,
...
var fileDescriptorExecutor = []byte{
	...
	,
}
