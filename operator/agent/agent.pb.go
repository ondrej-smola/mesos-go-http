...
type Response struct {
	Type                Response_Type                 `protobuf:"varint,1,opt,name=type,enum=mesos.v1.agent.Response_Type" json:"type"`
...
type Response_GetContainers_Container struct {
	...
	ContainerID        mesos_v1.ContainerID         `protobuf:"bytes,4,req,name=container_id" json:"container_id"`
...
type Response_GetTasks struct {
	...
	// registered.
	QueuedTasks []mesos_v1.Task `protobuf:"bytes,2,rep,name=queued_tasks" json:"queued_tasks"`
	// Tasks that are running.
	LaunchedTasks []mesos_v1.Task `protobuf:"bytes,3,rep,name=launched_tasks" json:"launched_tasks"`
	// Tasks that are terminated but pending updates.
	TerminatedTasks []mesos_v1.Task `protobuf:"bytes,4,rep,name=terminated_tasks" json:"terminated_tasks"`
	// Tasks that are terminated and updates acked.
	CompletedTasks []mesos_v1.Task `protobuf:"bytes,5,rep,name=completed_tasks" json:"completed_tasks"`
}
...
func (this *Response_GetContainers_Container) String() string {
	...
	s := strings.Join([]string{`&Response_GetContainers_Container{`,
		...
		`ContainerID:` + strings.Replace(strings.Replace(this.ContainerID.String(), "ContainerID", "mesos_v1.ContainerID", 1), `&`, ``, 1) + `,`,
		`ContainerStatus:` + strings.Replace(fmt.Sprintf("%v", this.ContainerStatus), "ContainerStatus", "mesos_v1.ContainerStatus", 1) + `,`,
		`ResourceStatistics:` + strings.Replace(fmt.Sprintf("%v", this.ResourceStatistics), "ResourceStatistics", "mesos_v1.ResourceStatistics", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Response_GetTasks) String() string {
	...
	s := strings.Join([]string{`&Response_GetTasks{`,
		...
		`QueuedTasks:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.QueuedTasks), "Task", "mesos_v1.Task", 1), `&`, ``, 1) + `,`,
		`LaunchedTasks:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.LaunchedTasks), "Task", "mesos_v1.Task", 1), `&`, ``, 1) + `,`,
		`TerminatedTasks:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.TerminatedTasks), "Task", "mesos_v1.Task", 1), `&`, ``, 1) + `,`,
